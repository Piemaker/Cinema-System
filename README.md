...
Admins are able to view/search/sort/add/delete/update a movie, view/search/sort/add/delte actors, get system logs of (insert/delete/update) events, get number of genres of movies and number of moives in each genre as well as number of movies with a specific rating.
